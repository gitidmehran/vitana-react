...
const CcmMonthlyCarePlan = ({ questionIds }: { questionIds: any }) => {
  ...
  function fetchccmgeneralCareplan() {
    ...
    getCCMGeneralCarePlan(questionIds, "").then(({ data: response }) => {
      dispatch(setLoader(false));
      dispatch(setDateofService(response.row?.monthly_assessment?.date_of_service));
  ...
  const dateOfService = rowdata?.monthly_assessment?.date_of_service;
                              ...
                              <tr>
                                <td colSpan={7}>
                                  <p className="pl-5">
                                    ...
                                    <p>
                                      Unhealthy fats – "Trans" fats are especially unhealthy.
                                      They are found in margarines, many fast foods, and some store-bought baked goods.
                                      "Saturated" fats are found in animal products like meats, egg yolks, butter, cheese, and full-fat milk products.
                                      Unhealthy fats can raise your cholesterol level and increase your chance of getting heart disease.
                                    </p>
                                  </p>
                                </td>
                                <td colSpan={2}>
                              ...
                              <tr>
                                <td colSpan={7}>
                                  <p className="pl-5">
                                    ...
                                    <p>
                                      Smoking, drinking excessive alcohol & eating foods that have a lot of saturated fats or trans fats.
                                      Most animal fats are saturated. The fats of plants and fish are generally healthy.
                                      Many processed foods like foods deep-fried and sausage are high in saturated fat content and not healthy.
                                      Sitting too much instead of being active. Being stressed. Inheriting genes that make your cholesterol level unhealthy. Being overweight.
                                    </p>
                                  </p>
                                </td>
                                <td colSpan={2}>
                              ...
                              <tr>
                                <td colSpan={7}>
                                  <p className="pl-5">
                                    ...
                                    <p>
                                      It should be mandatory to do labs like levels of triglycerides, cholesterol levels.
                                      Patient should know the levels of LDL. It should be less than 130 if patient is not Diabetic or have heart disease.
                                      If patient has heart disease, then it should be less than 100 and if Diabetes then the level be less than 70
                                    </p>
                                  </p>
                                </td>
                                <td colSpan={2}>
                              ...
                              <tr>
                                <td colSpan={7}>
                                  <p className="pl-5">
                                    ...
                                    <p>
                                      Conditions like obesity, diabetes, hypertension, and heart disease.
                                      It can also coexist with arthritis, sleep apnea, and atrial fibrillation.
                                      In many cases, managing high cholesterol will help manage other conditions.
                                      Your doctor can provide personalized guidance depending on your comorbidities.
                                    </p>
                                  </p>
                                </td>
                                <td colSpan={2}>
                              ...
                              <tr>
                                <td colSpan={7}>
                                  <p className="pl-5">
                                    ...
                                    <p>
                                      Total Cholesterol has LDL (Bad Cholesterol) and HDL (Good Cholesterol).
                                      If you have an excess amount of LDL (LIPIDS) in your bloodstream, waxy plaques can build up along your artery walls, causing arteries to narrow.
                                      Over time, arteries may become damaged with these plaques and susceptible to blood clots.
                                      These blood clots can dislodge and block a small vessel in the heart causing heart attack.
                                    </p>
                                  </p>
                                </td>
                                <td colSpan={2}>
                              ...
                              <tr>
                                <td colSpan={7}>
                                  <p className="pl-5">
                                    ...
                                    <p>
                                      The most beneficial changes result from reducing intake of saturated and trans fats;
                                      mostly found in commercially friend food like French fries and increasing intake of polyunsaturated and monounsaturated fats.
                                      Low-carbohydrate, or low-fat diet also has beneficial effects in reducing intake of dietary cholesterol.
                                      Increasing intake of soluble fiber and soy protein, and eating fatty marine fish or taking marine-derived omega-3 fatty acid supplements is also beneficial.
                                    </p>
                                  </p>
                                </td>
                                <td colSpan={2}>
                              ...
                              <tr>
                                <td colSpan={7}>
                                  <p className="pl-5">
                                    ...
                                    <p>
                                      Your nutritionist will guide you toward healthy food choices while helping you enjoy the foods you are eating.
                                      Nutritionists can also teach you about healthy food habits and behaviors that encourage weight loss.
                                      Healthy habits may include eating at the dining table, weighing your food or avoiding late night snacks.
                                      The goal of this education is to help you develop healthy habits for the rest of your life.
                                    </p>
                                  </p>
                                </td>
                                <td colSpan={2}>
                              ...
                              <tr>
                                <td colSpan={7}>
                                  <p className="pl-5">
                                    ...
                                    <p>
                                      Any amount of exercise is better than sedentary lifestyle. It is important to incorporate exercise as a life habit.
                                      Individual should engage in moderate-intensity physical exercise performed for a minimum of 10 minutes four times a week or vigorous-intensity exercise (jogging) performed for a minimum of 20 minutes twice a week.
                                      Moderate-intensity exercise is defined as activity sufficient to break a sweat or noticeably raise the heart rate (eg, walking briskly, using an exercise bicycle).
                                    </p>
                                  </p>
                                </td>
                                <td colSpan={2}>
                          ...
                          <>
                            ...
                            {typeof diabetesmellitus?.monitoring_blood_sugar_status !== "undefined" && diabetesmellitus?.monitoring_blood_sugar_status !== "Not Started" ? (
                              <tr>
                                ...
                                <td colSpan={1} style={{ paddingLeft: "10px" }}>
                                  {
                                    diabetesmellitus?.monitoring_blood_sugar_status
                                  }
                                </td>
                              </tr>
                            ) : null}
                          ...
                          <>
                            ...
                            {typeof diabetesmellitus?.abc_of_diabetes_status !== "undefined" && diabetesmellitus?.abc_of_diabetes_status !== "Not Started" ? (
                              <tr>
                                ...
                                <td colSpan={2}> {diabetesmellitus?.abc_of_diabetes_start_date} </td>
                                <td colSpan={2} style={{ paddingLeft: "10px" }}> {diabetesmellitus?.abc_of_diabetes_end_date} </td>
                                <td colSpan={1} style={{ paddingLeft: "10px" }}> {diabetesmellitus?.abc_of_diabetes_status} </td>
                              </tr>
                            ) : null}
                            ...
                            {typeof diabetesmellitus?.undercontrol_weight_status !== "undefined" && diabetesmellitus?.undercontrol_weight_status !== "Not Started" ? (
                              <tr>
                                ...
                                <td colSpan={2}>{diabetesmellitus?.undercontrol_weight_start_date} </td>
                                <td colSpan={2} style={{ paddingLeft: "10px" }}>{diabetesmellitus?.undercontrol_weight_end_date} </td>
                                <td colSpan={1} style={{ paddingLeft: "10px" }}>{diabetesmellitus?.undercontrol_weight_status} </td>
                              </tr>
                            ) : null}
                            ...
                            {typeof diabetesmellitus?.assess_the_pattern_status !== "undefined" && diabetesmellitus?.assess_the_pattern_status !== "Not Started" ? (
                              <tr>
                                ...
                                <td colSpan={2}> {diabetesmellitus?.seeing_dietician_start_date} </td>
                                <td colSpan={2} style={{ paddingLeft: "10px" }}> {diabetesmellitus?.seeing_dietician_end_date} </td>
                                <td colSpan={1} style={{ paddingLeft: "10px" }}> {diabetesmellitus?.seeing_dietician_status} </td>
                              </tr>
                            ) : null}
                          </>
                        ) : null}
                          ...
                          <>
                            ...
                            {typeof diabetesmellitus?.signs_of_hyperglycemia_status !== "undefined" && diabetesmellitus?.signs_of_hyperglycemia_status !== "Not Started" ? (
                              <tr>
                                ...
                                <td colSpan={2} style={{ paddingLeft: "10px" }}>{diabetesmellitus?.signs_of_hyperglycemia_end_date}</td>
                                <td colSpan={1} style={{ paddingLeft: "10px" }}>{diabetesmellitus?.signs_of_hyperglycemia_status}</td>
                              </tr>
                            ) : null}
                            ...
                            {typeof diabetesmellitus?.prevention_of_hyperglycemia_status !== "undefined" && diabetesmellitus?.prevention_of_hyperglycemia_status !== "Not Started" ? (
                              <tr>
                                ...
                                <td colSpan={2}> {diabetesmellitus?.prevention_of_hyperglycemia_start_date} </td>
                                <td colSpan={2} style={{ paddingLeft: "10px" }}> {diabetesmellitus?.prevention_of_hyperglycemia_end_date}
                                </td>
                                <td colSpan={1} style={{ paddingLeft: "10px" }}> {diabetesmellitus?.prevention_of_hyperglycemia_status}
                                </td>
                              </tr>
                            ) : null}
                            ...
                            {typeof diabetesmellitus?.lower_blood_sugar_status !== "undefined" && diabetesmellitus?.lower_blood_sugar_status !== "Not Started" ? (
                              <tr>
                                ...
                                <td colSpan={2}> {diabetesmellitus?.lower_blood_sugar_start_date}</td>
                                <td colSpan={2} style={{ paddingLeft: "10px" }}>{diabetesmellitus?.lower_blood_sugar_end_date}</td>
                                <td colSpan={1} style={{ paddingLeft: "10px" }}>{diabetesmellitus?.lower_blood_sugar_status}</td>
                              </tr>
                            ) : null}
                          </>
                        ) : null}
                          ...
                          <>
                            ...
                            {typeof diabetesmellitus?.sugar_effect_on_eye_status !== "undefined" && diabetesmellitus?.sugar_effect_on_eye_status !== "Not Started" ? (
                              <tr>
                                ...
                                <td colSpan={2}> {diabetesmellitus?.sugar_effect_on_eye_start_date} </td>
                                <td colSpan={2} style={{ paddingLeft: "10px" }}>{diabetesmellitus?.sugar_effect_on_eye_end_date}</td>
                                <td colSpan={1} style={{ paddingLeft: "10px" }}>{diabetesmellitus?.sugar_effect_on_eye_status}</td>
                              </tr>
                            ) : null}
                            ...
                            {typeof diabetesmellitus?.sugar_ways_to_effect_on_eye_status !== "undefined" && diabetesmellitus?.sugar_ways_to_effect_on_eye_status !== "Not Started" ? (
                              <tr>
                                ...
                                <td colSpan={2}> {diabetesmellitus?.sugar_ways_to_effect_on_eye_start_date} </td>
                                <td colSpan={2} style={{ paddingLeft: "10px" }}> {diabetesmellitus?.sugar_ways_to_effect_on_eye_end_date}
                                </td>
                                <td colSpan={1} style={{ paddingLeft: "10px" }}> {diabetesmellitus?.sugar_ways_to_effect_on_eye_status}
                                </td>
                              </tr>
                            ) : null}
                          </>
                          ...
                          <>
                            ...
                            {typeof diabetesmellitus?.foot_nerves_damage_status !== "undefined" && diabetesmellitus?.foot_nerves_damage_status !== "Not Started" ? (
                              <tr>
                                ...
                                <td colSpan={2}> {diabetesmellitus?.foot_nerves_damage_start_date} </td>
                                <td colSpan={2} style={{ paddingLeft: "10px" }}>{diabetesmellitus?.foot_nerves_damage_end_date}</td>
                                <td colSpan={1} style={{ paddingLeft: "10px" }}>{diabetesmellitus?.foot_nerves_damage_status}</td>
                              </tr>
                            ) : null}
                            ...
                            {typeof diabetesmellitus?.protect_feet_status !== "undefined" && diabetesmellitus?.protect_feet_status !== "Not Started" ? (
                              <tr>
                                ...
                                <td colSpan={2}> {diabetesmellitus?.protect_feet_start_date} </td>
                                <td colSpan={2} style={{ paddingLeft: "10px" }}> {diabetesmellitus?.protect_feet_end_date}
                                </td>
                                <td colSpan={1} style={{ paddingLeft: "10px" }}> {diabetesmellitus?.protect_feet_status}
                                </td>
                              </tr>
                            ) : null}
                            ...
                            {typeof diabetesmellitus?.foot_examination_status !== "undefined" && diabetesmellitus?.foot_examination_status !== "Not Started" ? (
                              <tr>
                                ...
                                <td colSpan={2}> {diabetesmellitus?.foot_examination_start_date} </td>
                                <td colSpan={2} style={{ paddingLeft: "10px" }}> {diabetesmellitus?.foot_examination_end_date}
                                </td>
                                <td colSpan={1} style={{ paddingLeft: "10px" }}> {diabetesmellitus?.foot_examination_status}
                                </td>
                              </tr>
                            ) : null}
                          </>
                          ...
                          <>
                            ...
                            {typeof diabetesmellitus?.death_cause_in_diabetes_status !== "undefined" && diabetesmellitus?.death_cause_in_diabetes_status !== "Not Started" ? (
                              <tr>
                                ...
                                <td colSpan={2}> {diabetesmellitus?.death_cause_in_diabetes_start_date} </td>
                                <td colSpan={2} style={{ paddingLeft: "10px" }}>{diabetesmellitus?.death_cause_in_diabetes_end_date}</td>
                                <td colSpan={1} style={{ paddingLeft: "10px" }}>{diabetesmellitus?.death_cause_in_diabetes_status}</td>
                              </tr>
                            ) : null}
                            ...
                            {typeof diabetesmellitus?.risk_of_cardio_disease_status !== "undefined" && diabetesmellitus?.risk_of_cardio_disease_status !== "Not Started" ? (
                              <tr>
                                ...
                                <td colSpan={2}> {diabetesmellitus?.risk_of_cardio_disease_start_date} </td>
                                <td colSpan={2} style={{ paddingLeft: "10px" }}> {diabetesmellitus?.risk_of_cardio_disease_end_date}
                                </td>
                                <td colSpan={1} style={{ paddingLeft: "10px" }}> {diabetesmellitus?.risk_of_cardio_disease_status}
                                </td>
                              </tr>
                            ) : null}
                            ...
                            {typeof diabetesmellitus?.cholesterol_healthy_range_status !== "undefined" && diabetesmellitus?.cholesterol_healthy_range_status !== "Not Started" ? (
                              <tr>
                                ...
                                <td colSpan={2}> {diabetesmellitus?.cholesterol_healthy_range_start_date} </td>
                                <td colSpan={2} style={{ paddingLeft: "10px" }}> {diabetesmellitus?.cholesterol_healthy_range_end_date}
                                </td>
                                <td colSpan={1} style={{ paddingLeft: "10px" }}> {diabetesmellitus?.cholesterol_healthy_range_status}
                                </td>
                              </tr>
                            ) : null}
                            ...
                            {typeof diabetesmellitus?.low_dose_aspirin_status !== "undefined" && diabetesmellitus?.low_dose_aspirin_status !== "Not Started" ? (
                              <tr>
                                ...
                                <td colSpan={2}> {diabetesmellitus?.low_dose_aspirin_start_date} </td>
                                <td colSpan={2} style={{ paddingLeft: "10px" }}> {diabetesmellitus?.low_dose_aspirin_end_date}
                                </td>
                                <td colSpan={1} style={{ paddingLeft: "10px" }}> {diabetesmellitus?.low_dose_aspirin_status}
                                </td>
                              </tr>
                            ) : null}
                          </>
                          ...
                          <>
                            ...
                            {typeof diabetesmellitus?.diabetes_effect_on_kidneys_status !== "undefined" && diabetesmellitus?.diabetes_effect_on_kidneys_status !== "Not Started" ? (
                              <tr>
                                ...
                                <td colSpan={2}> {diabetesmellitus?.diabetes_effect_on_kidneys_start_date} </td>
                                <td colSpan={2} style={{ paddingLeft: "10px" }}>{diabetesmellitus?.diabetes_effect_on_kidneys_end_date}</td>
                                <td colSpan={1} style={{ paddingLeft: "10px" }}>{diabetesmellitus?.diabetes_effect_on_kidneys_status}</td>
                              </tr>
                            ) : null}
                            ...
                            {typeof diabetesmellitus?.know_how_kidneys_effected_status !== "undefined" && diabetesmellitus?.know_how_kidneys_effected_status !== "Not Started" ? (
                              <tr>
                                ...
                                <td colSpan={2}> {diabetesmellitus?.know_how_kidneys_effected_start_date} </td>
                                <td colSpan={2} style={{ paddingLeft: "10px" }}> {diabetesmellitus?.know_how_kidneys_effected_end_date}
                                </td>
                                <td colSpan={1} style={{ paddingLeft: "10px" }}> {diabetesmellitus?.know_how_kidneys_effected_status}
                                </td>
                              </tr>
                            ) : null}
                            ...
                            {typeof diabetesmellitus?.protect_kidneys_status !== "undefined" && diabetesmellitus?.protect_kidneys_status !== "Not Started" ? (
                              <tr>
                                ...
                                <td colSpan={2}> {diabetesmellitus?.protect_kidneys_start_date} </td>
                                <td colSpan={2} style={{ paddingLeft: "10px" }}> {diabetesmellitus?.protect_kidneys_end_date}
                                </td>
                                <td colSpan={1} style={{ paddingLeft: "10px" }}> {diabetesmellitus?.protect_kidneys_status}
                                </td>
                              </tr>
                            ) : null}
                          </>
                          ...
                          <>
                            ...
                            {typeof diabetesmellitus?.bp_recommendation_status !== "undefined" && diabetesmellitus?.bp_recommendation_status !== "Not Started" ? (
                              <tr>
                                ...
                                <td colSpan={2}> {diabetesmellitus?.bp_recommendation_start_date} </td>
                                <td colSpan={2} style={{ paddingLeft: "10px" }}>{diabetesmellitus?.bp_recommendation_end_date}</td>
                                <td colSpan={1} style={{ paddingLeft: "10px" }}>{diabetesmellitus?.bp_recommendation_status}</td>
                              </tr>
                            ) : null}
                            ...
                            {typeof diabetesmellitus?.how_to_lower_bp_status !== "undefined" && diabetesmellitus?.how_to_lower_bp_status !== "Not Started" ? (
                              <tr>
                                ...
                                <td colSpan={2}> {diabetesmellitus?.how_to_lower_bp_start_date} </td>
                                <td colSpan={2} style={{ paddingLeft: "10px" }}> {diabetesmellitus?.how_to_lower_bp_end_date}
                                </td>
                                <td colSpan={1} style={{ paddingLeft: "10px" }}> {diabetesmellitus?.how_to_lower_bp_status}
                                </td>
                              </tr>
                            ) : null}
                          </>
                          ...
                          <>
                            ...
                            {typeof diabetesmellitus?.monitor_hunger_and_fatigue_status !== "undefined" && diabetesmellitus?.monitor_hunger_and_fatigue_status !== "Not Started" ? (
                              <tr>
                                ...
                                <td colSpan={2}> {diabetesmellitus?.monitor_hunger_and_fatigue_start_date} </td>
                                <td colSpan={2} style={{ paddingLeft: "10px" }}> {diabetesmellitus?.monitor_hunger_and_fatigue_end_date} </td>
                                <td colSpan={1} style={{ paddingLeft: "10px" }}> {diabetesmellitus?.monitor_hunger_and_fatigue_status} </td>
                              </tr>
                            ) : null}
                            ...
                            {typeof diabetesmellitus?.assess_frequent_urination_status !== "undefined" && diabetesmellitus?.assess_frequent_urination_status !== "Not Started" ? (
                              <tr>
                                ...
                                <td colSpan={2}> {diabetesmellitus?.assess_frequent_urination_start_date} </td>
                                <td colSpan={2} style={{ paddingLeft: "10px" }}> {diabetesmellitus?.assess_frequent_urination_end_date} </td>
                                <td colSpan={1} style={{ paddingLeft: "10px" }}> {diabetesmellitus?.assess_frequent_urination_status} </td>
                              </tr>
                            ) : null}
                            {typeof diabetesmellitus?.assess_slow_healing_status !== "undefined" && diabetesmellitus?.assess_slow_healing_status !== "Not Started" ? (
                              <tr>
                                ...
                                <td colSpan={1} style={{ paddingLeft: "10px" }}>
                                  {diabetesmellitus?.assess_slow_healing_status}
                                </td>
                              </tr>
                            ) : null}
                          </>
                          ...
                          <>
                            ...
                            {typeof ckdassessment?.educate_on_ckd_status !== "undefined" && ckdassessment?.educate_on_ckd_status !== "Not Started" ? (
                              <tr>
                                ...
                                <td colSpan={1} style={{ paddingLeft: "10px" }}>
                                  {ckdassessment?.educate_on_ckd_status}
                                </td>
                              </tr>
                            ) : null}
                            ...
                            {typeof ckdassessment?.worsening_symptoms_status !== "undefined" && ckdassessment?.worsening_symptoms_status !== "Not Started" ? (
                              <tr>
                                ...
                                <td colSpan={1} style={{ paddingLeft: "10px" }}>
                                  {ckdassessment?.worsening_symptoms_status}
                                </td>
                              </tr>
                            ) : null}
                            ...
                            {typeof ckdassessment?.followup_importance_status !== "undefined" && ckdassessment?.followup_importance_status !== "Not Started" ? (
                              <tr>
                                ...
                                <td colSpan={1} style={{ paddingLeft: "10px" }}>
                                  {ckdassessment?.followup_importance_status}
                                </td>
                              </tr>
                            ) : null}
                            ...
                            {typeof ckdassessment?.prevent_worsening_status !== "undefined" && ckdassessment?.prevent_worsening_status !== "Not Started" ? (
                              <tr>
                                ...
                                <td colSpan={1} style={{ paddingLeft: "10px" }}>
                                  {ckdassessment?.prevent_worsening_status}
                                </td>
                              </tr>
                            ) : null}
                            ...
                            {typeof ckdassessment?.aviod_medications_status !== "undefined" && ckdassessment?.aviod_medications_status !== "Not Started" ? (
                              <tr>
                                ...
                                <td colSpan={1} style={{ paddingLeft: "10px" }}>
                                  {ckdassessment?.aviod_medications_status}
                                </td>
                              </tr>
                            ) : null}
                            ...
                            {typeof ckdassessment?.ckd_treatment_status !== "undefined" && ckdassessment?.ckd_treatment_status !== "Not Started" ? (
                              <tr>
                                ...
                                <td colSpan={1} style={{ paddingLeft: "10px" }}>
                                  {ckdassessment?.ckd_treatment_status}
                                </td>
                              </tr>
                            ) : null}
                          </>
                          ...
                          <>
                            ...
                            {typeof ckdassessment?.educate_on_risk_factors_status !== "undefined" && ckdassessment?.educate_on_risk_factors_status !== "Not Started" ? (
                              <tr>
                                ...
                                <td colSpan={1} style={{ paddingLeft: "10px" }}>
                                  {ckdassessment?.educate_on_risk_factors_status}
                                </td>
                              </tr>
                            ) : null}
                            ...
                            {typeof ckdassessment?.educate_on_lowering_risk_status !== "undefined" && ckdassessment?.educate_on_lowering_risk_status !== "Not Started" ? (
                              <tr>
                                ...
                                <td colSpan={1} style={{ paddingLeft: "10px" }}>
                                  {ckdassessment?.educate_on_lowering_risk_status}
                                </td>
                              </tr>
                            ) : null}
                            ...
                            {typeof ckdassessment?.hypertension_effects_risk_status !== "undefined" && ckdassessment?.hypertension_effects_risk_status !== "Not Started" ? (
                              <tr>
                                ...
                                <td colSpan={1} style={{ paddingLeft: "10px" }}>
                                  {ckdassessment?.hypertension_effects_risk_status}
                                </td>
                              </tr>
                            ) : null}
                            ...
                            {typeof ckdassessment?.healthy_diet_status !== "undefined" && ckdassessment?.healthy_diet_status !== "Not Started" ? (
                              <tr>
                                ...
                                <td colSpan={1} style={{ paddingLeft: "10px" }}>
                                  {ckdassessment?.healthy_diet_status}
                                </td>
                              </tr>
                            ) : null}
                            ...
                            {typeof ckdassessment?.protein_effects_status !== "undefined" && ckdassessment?.protein_effects_status !== "Not Started" ? (
                              <tr>
                                ...
                                <td colSpan={1} style={{ paddingLeft: "10px" }}>
                                  {ckdassessment?.protein_effects_status}
                                </td>
                              </tr>
                            ) : null}
                            ...
                            {typeof ckdassessment?.elevated_cholesterol_status !== "undefined" && ckdassessment?.elevated_cholesterol_status !== "Not Started" ? (
                              <tr>
                                ...
                                <td colSpan={1} style={{ paddingLeft: "10px" }}>
                                  {ckdassessment?.elevated_cholesterol_status}
                                </td>
                              </tr>
                            ) : null}
                          </>
                          ...
                          <>
                            ...
                            {typeof ckdassessment?.educate_on_dkd_status !== "undefined" && ckdassessment?.educate_on_dkd_status !== "Not Started" ? (
                              <tr>
                                ...
                                <td colSpan={1} style={{ paddingLeft: "10px" }}>
                                  {ckdassessment?.educate_on_dkd_status}
                                </td>
                              </tr>
                            ) : null}
                            ...
                            {typeof ckdassessment?.dkd_symptoms_status !== "undefined" && ckdassessment?.dkd_symptoms_status !== "Not Started" ? (
                              <tr>
                                ...
                                <td colSpan={1} style={{ paddingLeft: "10px" }}>
                                  {ckdassessment?.dkd_symptoms_status}
                                </td>
                              </tr>
                            ) : null}
                            ...
                            {typeof ckdassessment?.dkd_risk_factors_status !== "undefined" && ckdassessment?.dkd_risk_factors_status !== "Not Started" ? (
                              <tr>
                                ...
                                <td colSpan={1} style={{ paddingLeft: "10px" }}>
                                  {ckdassessment?.dkd_risk_factors_status}
                                </td>
                              </tr>
                            ) : null}
                            ...
                            {typeof ckdassessment?.dkd_progression_status !== "undefined" && ckdassessment?.dkd_progression_status !== "Not Started" ? (
                              <tr>
                                ...
                                <td colSpan={1} style={{ paddingLeft: "10px" }}>
                                  {ckdassessment?.dkd_progression_status}
                                </td>
                              </tr>
                            ) : null}
                            ...
                            {typeof ckdassessment?.healthy_lifestyle_effect_status !== "undefined" && ckdassessment?.healthy_lifestyle_effect_status !== "Not Started" ? (
                              <tr>
                                ...
                                <td colSpan={1} style={{ paddingLeft: "10px" }}>
                                  {ckdassessment?.healthy_lifestyle_effect_status}
                                </td>
                              </tr>
                            ) : null}
                            ...
                            {typeof ckdassessment?.blood_sugar_control_status !== "undefined" && ckdassessment?.blood_sugar_control_status !== "Not Started" ? (
                              <tr>
                                ...
                                <td colSpan={1} style={{ paddingLeft: "10px" }}>
                                  {ckdassessment?.blood_sugar_control_status}
                                </td>
                              </tr>
                            ) : null}
                            ...
                            {typeof ckdassessment?.hba1c_importance_status !== "undefined" && ckdassessment?.hba1c_importance_status !== "Not Started" ? (
                              <tr>
                                ...
                                <td colSpan={1} style={{ paddingLeft: "10px" }}>
                                  {ckdassessment?.hba1c_importance_status}
                                </td>
                              </tr>
                            ) : null}
                            ...
                            {typeof ckdassessment?.control_blood_sugar_status !== "undefined" && ckdassessment?.control_blood_sugar_status !== "Not Started" ? (
                              <tr>
                                ...
                                <td colSpan={1} style={{ paddingLeft: "10px" }}>
                                  {ckdassessment?.control_blood_sugar_status}
                                </td>
                              </tr>
                            ) : null}
                            ...
                            {typeof ckdassessment?.bp_effect_on_dkd_status !== "undefined" && ckdassessment?.bp_effect_on_dkd_status !== "Not Started" ? (
                              <tr>
                                ...
                                <td colSpan={1} style={{ paddingLeft: "10px" }}>
                                  {ckdassessment?.bp_effect_on_dkd_status}
                                </td>
                              </tr>
                            ) : null}
                            ...
                            {typeof ckdassessment?.hypertension_treatment_status !== "undefined" && ckdassessment?.hypertension_treatment_status !== "Not Started" ? (
                              <tr>
                                ...
                                <td colSpan={1} style={{ paddingLeft: "10px" }}>
                                  {ckdassessment?.hypertension_treatment_status}
                                </td>
                              </tr>
                            ) : null}
                          </>
                          ...
                          <>
                            ...
                            {typeof ckdassessment?.ckd_heart_status !== "undefined" && ckdassessment?.ckd_heart_status !== "Not Started" ? (
                              <tr>
                                ...
                                <td colSpan={1} style={{ paddingLeft: "10px" }}>
                                  {ckdassessment?.ckd_heart_status}
                                </td>
                              </tr>
                            ) : null}
                          </>
                      ...
                      <>
                        ...
                        {chfassessment?.goal1_status !== "" ? (
                          <>
                            ...
                            {typeof chfassessment?.understanding_regarding_disease_status !==
                              "undefined" &&
                              chfassessment?.understanding_regarding_disease_status !==
                              "Not Started" ? (
                              <tr>
                                <td colSpan={7}>
                                  <p className="pl-5">
                            ...
                            {typeof chfassessment?.monitor_blood_pressure_status !==
                              "undefined" &&
                              chfassessment?.monitor_blood_pressure_status !==
                              "Not Started" ? (
                              <tr>
                                <td colSpan={7}>
                                  <p className="pl-5">
                            ...
                            {typeof chfassessment?.monitor_ECG_levels_status !==
                              "undefined" &&
                              chfassessment?.monitor_ECG_levels_status !==
                              "Not Started" ? (
                              <tr>
                                <td colSpan={7}>
                                  <p className="pl-5">
                        ...
                        {chfassessment?.goal2_status !== "" ? (
                          <>
                            ...
                            {typeof chfassessment?.adequate_cardiac_status !==
                              "undefined" &&
                              chfassessment?.adequate_cardiac_status !==
                              "Not Started" ? (
                              <tr>
                                <td colSpan={7}>
                                  <p className="pl-5">
                            ...
                            {typeof chfassessment?.cerebral_hypoperfusion_status !==
                              "undefined" &&
                              chfassessment?.cerebral_hypoperfusion_status !==
                              "Not Started" ? (
                              <tr>
                                <td colSpan={7}>
                                  <p className="pl-5">
                        ...
                        {chfassessment?.goal3_status !== "" ? (
                          <>
                            ...
                            {typeof chfassessment?.pulmonary_hygiene_status !==
                              "undefined" &&
                              chfassessment?.pulmonary_hygiene_status !==
                              "Not Started" ? (
                              <tr>
                                <td colSpan={7}>
                                  <p className="pl-5">
                                    ...
                                    of mucus and other secretions. This ensures
                                    that your lungs get enough oxygen, and your
                                    respiratory system works efficiently. There
                                    are several pulmonary hygiene methods and
                                    approaches. Some can be done on your own at
                                    home, while others require a visit to your
                                    healthcare provider like breathing exercise,
                                    relaxed breathing, Huffing=This exercise
                                    requires you to “huff” by breathing hard out
                                    of your mouth, as though you were creating
                                    fog on a mirror. Spirometry, This method of
                                    strengthening and controlling your breathing
                                    uses a device called an incentive
                                    spirometer.
                                  </p>
                                </td>
                                <td colSpan={2}>
                            ...
                            {typeof chfassessment?.respiratory_distress_status !==
                              "undefined" &&
                              chfassessment?.respiratory_distress_status !==
                              "Not Started" ? (
                              <tr>
                                <td colSpan={7}>
                                  <p className="pl-5">
                                    ...
                                    observed that, in moderate-to-severe cases,
                                    the respiratory system compliance reduces
                                    upon elevating the head-end of the bed, and
                                    vice-versa, which can be utilized to improve
                            ...
                            {typeof chfassessment?.monitor_ABG_levels_status !==
                              "undefined" &&
                              chfassessment?.monitor_ABG_levels_status !==
                              "Not Started" ? (
                              <tr>
                                <td colSpan={7}>
                                  <p className="pl-5">
                                    ...
                                    work to keep your acid-base balance normal.
                                    So, the acid-base measurement from an ABG
                                    test can help diagnose and monitor
                        ...
                        {chfassessment?.goal4_status !== "" ? (
                          <>
                            ...
                            {typeof chfassessment?.pulmonary_edemas_status !==
                              "undefined" &&
                              chfassessment?.pulmonary_edemas_status !==
                              "Not Started" ? (
                              <tr>
                                <td colSpan={7}>
                                  <p className="pl-5">
                                    ...
                                    much fluid in the lungs. This fluid collects
                                    in the many air sacs in the lungs, making it
                                    difficult to breathe. It needs to be monitor
                                    by feeling any difficulty in respiration.
                                  </p>
                                </td>
                                <td colSpan={2}>
                            ...
                            {typeof chfassessment?.conditions_of_Arrhythmias_status !==
                              "undefined" &&
                              chfassessment?.conditions_of_Arrhythmias_status !==
                              "Not Started" ? (
                              <tr>
                                <td colSpan={7}>
                                  <p className="pl-5">
                            ...
                            {typeof chfassessment?.cardiologist_visit_status !==
                              "undefined" &&
                              chfassessment?.cardiologist_visit_status !==
                              "Not Started" ? (
                              <tr>
                                <td colSpan={7}>
                                  <p className="pl-5">
                                    ...
                                    because the ECG is crucial in the detection
                                    of many abnormalities that may either cause
                                    or worsen HF. Therefore it is important to
                                    evaluate any changes in your heart sound by
                          ...
                          <>
                            <tr>
                              <td
                                ...
                                className="text-dark font-weight-bold"
                              >
                                To understand importance of daily weight
                                monitoring and recording in a daily log
                              </td>
                              <td colSpan={2}>
                                {
                            ...
                            {typeof chfassessment?.fluid_status_status !==
                              "undefined" &&
                              chfassessment?.fluid_status_status !==
                              "Not Started" ? (
                              <tr>
                                <td colSpan={7}>
                                  <p className="pl-5">
                        ...
                        {chfassessment?.goal6_status !== "" ? (
                          <>
                            ...
                            {typeof chfassessment?.antiarrhythmias_status !==
                              "undefined" &&
                              chfassessment?.antiarrhythmias_status !==
                              "Not Started" ? (
                              <tr>
                                <td colSpan={7}>
                                  <p className="pl-5">
                        ...
                        {typeof chfassessment?.followup_pcp_status !==
                          "undefined" &&
                          chfassessment?.followup_pcp_status !== "Not Started" ? (
                          <tr>
                            <td
                              colSpan={7}
                              className="text-dark font-weight-bold"
                            ...
                            <td colSpan={2}>
                              {chfassessment?.followup_pcp_start_date}
                            </td>
                            <td colSpan={2} style={{ paddingLeft: "10px" }}>
                              {chfassessment?.followup_pcp_end_date}
                            </td>
                            <td colSpan={1} style={{ paddingLeft: "10px" }}>
                              {chfassessment?.followup_pcp_status}
                            </td>
                          </tr>
                        ) : null}

                        {typeof chfassessment?.importance_medication_status !==
                          "undefined" &&
                          chfassessment?.importance_medication_status !==
                          "Not Started" ? (
                          <tr>
                            <td
                              colSpan={7}
                            ...
                            <td colSpan={2}>
                              {chfassessment?.importance_medication_start_date}
                            </td>
                            <td colSpan={2} style={{ paddingLeft: "10px" }}>
                              {chfassessment?.importance_medication_end_date}
                            </td>
                            <td colSpan={1} style={{ paddingLeft: "10px" }}>
                              {chfassessment?.importance_medication_status}
                            </td>
