...
const CcmAnnualQuestionnaireDownload: React.FC = () => {
        ...
        <div className="card main-card" style={{ minHeight: "auto" }}>
          <div className="card-body">
            ...
            <div className="row">
              <div className="col-lg-3 md-3 sm-3">
                <h6 className="d-inline ms-4">
                  CCM Annual Assessment Date: {moment(servicedate).format(dateFormat)}
                </h6>
              </div>
              <div className="col-lg-3 md-3 sm-3">
                <h6 className="d-inline ms-4">
                ...
                <div className="card-body">
                  <table className="table">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td>
                          Repeat address phrase John, Smith, 42, High St,
                          Bedford
                        </td>
                        <td className=" font-weight-bold text-right text-dark">
                    ...
                    <tbody>
                      <tr>
                        <td>
                          ...
                          dressed, grooming, bathing, walking or using the
                          toilet?
                        </td>
                        <td className=" font-weight-bold text-right text-dark">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td>
                          ...
                          engage in moderate exercise (like walking fast,
                  ...
                  <table className="table">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td className="font-weight-bold text-center text-dark align-right"></td>
                        <td className=" font-weight-bold text-center text-dark"></td>
                      </tr>

                      <tr>
                        <td>Instructed on Importance of Hand Washing</td>
                        <td className="font-weight-bold text-center text-dark align-right">
...
export default CcmAnnualQuestionnaireDownload;
