...
import { Button, DatePicker, message, Popover, Spin, Tooltip } from "antd";
import {
...
import { downloadCcmCareplan } from "../../actions/Questionnaire/questionnaire";
import fileDownload from "js-file-download";
import { OpenNotification } from "./../../Utilties/Utilties";

const CCMGeneralCarePlan: React.FC = () => {
  const { questionId, loading, programmId, diagnosis, monthly_assessment_id } = useAppSelector(
  ...
  function fetchccmgeneralCareplan() {
    ...
    getCCMGeneralCarePlan(id, value).then(({ data: response }) => {
      dispatch(setLoader(false));
      dispatch(setDateofService(response.row?.date_of_service));
      /* General Data */
      setTitle("CCM – Annual Care Plan");
  ...
  const handleBack = (questionId: any, programid: any) => {
    ...
    navigate(`/questionaire/edit/${questionId}`, {
      state: {
        ...
        disableFirstSeven: Boolean(monthly_assessment_id !== undefined && monthly_assessment_id !== ""),
        disableAfterSeven: Boolean(monthly_assessment_id === undefined || monthly_assessment_id === "")
      },
    });
  };
          ...
          <div className="card-body">
            <table className="table table-light">
              <tbody>
                ...
                <tr>
                  <td colSpan={9} className="text-dark font-weight-bolds">
                    <b>Patient shows understanding about importance of plain soap
                      in any form</b>
                  </td>
                  <td colSpan={1} className="text-center text-dark pr-0">
                ...
                {chronicDisease.CongestiveHeartFailure === true ? (
                  <>
                    ...
                    <tr>
                      <td colSpan={9}>
                        <p className="question-text mt-2 pl-5">
                          <b>Antiarrhythmias to increase cardiac performance
                            ...
                            the strength of your heart muscle contractions</b>
                        </p>
                      </td>
                      <td colSpan={1} className="text-center text-dark pr-0">
                ...
                {chronicDisease.DiabetesMellitus === true ? (
                  <>
                    ...
                    <tr>
                      <td colSpan={9} className="text-dark font-weight-bold">
                        To Understand the importance of Diabetic Diet.
                      </td>
                      <td colSpan={1} className="text-center text-dark pr-0"></td>
                      <td colSpan={1} className="text-center text-dark pr-0"></td>
                      <td colSpan={1} className="text-center text-dark pr-0">
                    ...
                    <tr>
                      <td colSpan={9} className="text-dark font-weight-bold">
                        To Understand the importance of Diabetic Foot Care.
                      </td>
                      <td colSpan={1} className="text-center text-dark pr-0" ></td>
                      <td colSpan={1} className="text-center text-dark pr-0" ></td>
                      <td colSpan={1} className="text-center text-dark pr-0">
                    ...
                    <tr>
                      <td colSpan={9} className="text-dark font-weight-bold">
                        To understand Cardiovascular Complications secondary to Diabetes.
                      </td>
                      <td colSpan={1} className="text-center text-dark pr-0" ></td>
                      <td colSpan={1} className="text-center text-dark pr-0" ></td>
                      <td colSpan={1} className="text-center text-dark pr-0">
                    ...
                    <tr>
                      <td colSpan={9} className="text-dark font-weight-bold">
                        To understand Kidney complications secondary to diabetes.
                      </td>
                      <td colSpan={1} className="text-center text-dark pr-0" ></td>
                      <td colSpan={1} className="text-center text-dark pr-0" ></td>
                      <td colSpan={1} className="text-center text-dark pr-0">
                    ...
                    <tr>
                      <td colSpan={9} className="text-dark font-weight-bold">
                        To recognize the importance if Blood Pressure control in diabetic patients.
                      </td>
                      <td colSpan={1} className="text-center text-dark pr-0" ></td>
                      <td colSpan={1} className="text-center text-dark pr-0" ></td>
                      <td colSpan={1} className="text-center text-dark pr-0">
                    ...
                    <tr>
                      <td colSpan={9} className="text-dark font-weight-bold">
                        To recognize the signs and symptoms of exacerbation that must be reported to the doctor/nurse.
                      </td>
                      <td colSpan={1} className="text-center text-dark pr-0" ></td>
                      <td colSpan={1} className="text-center text-dark pr-0" ></td>
                      <td colSpan={1} className="text-center text-dark pr-0">
